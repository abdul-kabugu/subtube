          ...
          <div className='mt-1 flex justify-between  items-center'>
            <div className='flex gap-2 items-center '>
             <Link href={`/channel/${data?.postById?.createdByAccount?.id }`}>
               ...
               <button className='hidden md:font-semibold md:text-lg bg-violet-800 text-white xs:px-2 xs:py-1 md:px-3 md:py-1.5 rounded-lg' onClick={() => subscribe()}>{isSubscriber ? "Subscribed" : "Subscribe"}</button>
          </div>
